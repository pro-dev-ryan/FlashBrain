...
const Blog = () => {
  return (
    <div className="flex flex-col justify-center items-center space-y-5 mb-10">
      <h1 className="glass text-center text-xl lg:text-2xl mt-5 lg:my-5 text-white font-heading font-bold w-fit bg-zinc-700 bg-opacity-30 p-2">
        This is Blog
      </h1>
      <div className="glassComponent w-[90%] lg:max-w-[40%] lg:m-auto p-2 block text-left rounded ">
        <h3 className="blogQue">
          <span className="text-white"> Que: </span>
          what is the purpose of react router ?
        </h3>
        <p className="glassComponent">
          <span className="text-white">Ans: </span> React Router helps the
      ...
      <div className="glassComponent w-[90%] lg:max-w-[40%] lg:m-auto p-2 block text-left rounded mb-5">
        <h3 className="blogQue">
          <span className="text-white"> Que: </span>
